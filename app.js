...
App.post("/add-product", (req, res) => {
  ...
  ProductTable INNER JOIN ProductDescription INNER JOIN ProductPrice
  ON
  ProductTable.product_id = ProductDescription.product_id
  AND
  ProductTable.product_id = ProductPrice.product_id`,
